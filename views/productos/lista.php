...
<main>
  ...
  <a href="index.php?accion=nuevo-producto"
     style="display:inline-block;margin:14px 0;padding:10px 18px;background:#0066B3;color:#fff;border-radius:8px;text-decoration:none;font-weight:700;">
    + Nuevo producto
  </a>
  ...
  <table>
    <thead>
      <tr>
        <th>Código</th><th>Nombre</th><th>Precio</th><th>Precio con IGV</th><th>Stock</th>
      </tr>
    </thead>
    <tbody>
